...
export default function Home() {
  ...
  useEffect(() => {
    ...
    dialog?.querySelector<HTMLElement>(".notice-confirm")?.focus();
    ...
    <main id="top">
      ...
      <section id="participation" className="participation-section" aria-labelledby="participation-title">
        <div className="participation-heading">
          ...
          <h2 id="participation-title">의대생·전공의도<br /><em>일정 부담 없이</em><br />참여할 수 있습니다</h2>
          <p className="participation-lead">본 프로그램은 매주 정해진 시간에 참여하는 13주 정규수업 형태가 아닙니다. 해외 석학과의 핵심 멘토링을 중심으로 진료·당직·수업·연구 일정을 고려해 유연하게 운영합니다.</p>
          <p className="participation-message">세부 일정은 멘티 선발 후 참여 가능한 요일과 시간을 확인하여 조율합니다.</p>
        </div>
        <div className="participation-details">
          <div className="participation-principles">
            <article><span>01 / CORE MENTORING</span><h3>소그룹 대면 멘토링</h3><p>글로벌 석학과의 핵심 멘토링은 소그룹 대면 참여를 원칙으로 진행합니다.</p></article>
          ...
          <p className="participation-encouragement">진료·당직·수업 일정으로 참여를 고민하고 있는 의대생·전공의(MD) 및 연구자도 부담 없이 지원해 주세요.</p>
        </div>
      </section>
