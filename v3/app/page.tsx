  ...
  return (
    <main id="top">
      ...
      <section id="apply" className="apply-section">
        ...
        <div className="apply-copy"><p className="kicker">05 / FOR EMERGING RESEARCHERS</p><h2>당신의 연구 질문을<br /><em>세계와 연결할 차례</em></h2><p>만 40세 미만 대학(원)생, 의대생, 전공의(MD), 박사후연구원 및 젊은 연구자를 대상으로 약 25명을 선발할 예정입니다.</p><div className="apply-notes"><span>1:5 소그룹</span><span>그룹별 3회</span><span>회차별 2시간 이상</span><span>성과물 1건 이상</span></div><div className="apply-actions"><a className="button button-primary" href="mailto:dku.gm2026@gmail.com?subject=글로벌 분자·세포생물학 멘토십 프로그램 신청 문의">프로그램 문의하기 <span>↗</span></a><a className="button button-download" href="/downloads/dku-global-mentorship-application-2026.docx" download="[서식1-4] 2026년_바이오헬스_글로벌_석학_멘토십_프로그램_지원서식_v1.docx">멘토링 프로그램 참여신청서 양식 다운로드 <span>DOCX ↓</span></a></div><div className="application-guide"><span>신청 이메일</span><a href="mailto:dku.gm2026@gmail.com?subject=글로벌 분자·세포생물학 멘토십 프로그램 신청">dku.gm2026@gmail.com</a><p>신청서 작성 후 첨부하여 제출</p></div></div>
      </section>
      ...
      <footer>
        ...
        <div className="footer-info"><strong>글로벌 분자·세포생물학 미래인재 양성 멘토십 프로그램</strong><p><b>주관</b> 단국대학교 <span>(단국노화연구소 DIA · 의과대학 · 단국대학교병원 · 의학융합학과)</span></p><p><b>지원</b> 보건복지부 · 한국보건산업진흥원</p><p><b>문의</b> <a href="mailto:dku.gm2026@gmail.com">dku.gm2026@gmail.com</a></p><p>충청남도 천안시 동남구 단대로 119</p></div>
